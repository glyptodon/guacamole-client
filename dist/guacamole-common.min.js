...
if(e)try{return Guacamole.AudioContextFactory.singleton||(Guacamole.AudioContextFactory.singleton=new e),Guacamole.AudioContextFactory.singleton}catch(e){}return null}},Guacamole.AudioPlayer=function(){this.sync=function(){}},Guacamole.AudioPlayer.isSupportedType=function(e){return Guacamole.RawAudioPlayer.isSupportedType(e)},Guacamole.AudioPlayer.getSupportedTypes=function(){return Guacamole.RawAudioPlayer.getSupportedTypes()},Guacamole.AudioPlayer.getInstance=function(e,t){return Guacamole.RawAudioPlayer.isSupportedType(t)?new Guacamole.RawAudioPlayer(e,t):null},Guacamole.RawAudioPlayer=function(e,t){var n=Guacamole.RawAudioFormat.parse(t),a=Guacamole.AudioContextFactory.getAudioContext(),r=a.currentTime,o=new Guacamole.ArrayBufferReader(e),i=1===n.bytesPerSample?window.Int8Array:window.Int16Array,u=1===n.bytesPerSample?128:32768,s=[],l=function(e){if(e.length<=1)return e[0]
var t=0
e.forEach(function(e){t+=e.length})
var n=0,a=new i(t)
return e.forEach(function(e){a.set(e,n),n+=e.length}),a},c=function(e){for(var t=Number.MAX_VALUE,a=e.length,r=Math.floor(e.length/n.channels),o=Math.floor(.02*n.rate),u=Math.max(n.channels*o,n.channels*(r-o)),s=u;s<e.length;s+=n.channels){for(var l=0,c=0;c<n.channels;c++)l+=Math.abs(e[s+c])
l<=t&&(a=s+n.channels,t=l)}return a===e.length?[e]:[new i(e.buffer.slice(0,a*n.bytesPerSample)),new i(e.buffer.slice(a*n.bytesPerSample))]},d=function(e){s.push(new i(e))},f=function(){var e=l(s)
return e?(s=c(e),e=s.shift()):null},h=function(e){var t=e.length/n.channels,o=a.currentTime
r<o&&(r=o)
for(var i=a.createBuffer(n.channels,t,n.rate),s=0;s<n.channels;s++)for(var l=i.getChannelData(s),c=s,d=0;d<t;d++)l[d]=e[c]/u,c+=n.channels
return i}
o.ondata=function(e){d(new i(e))
var t=f()
if(t){var o=a.currentTime
r<o&&(r=o)
var u=a.createBufferSource()
u.connect(a.destination),u.start||(u.start=u.noteOn),u.buffer=h(t),u.start(r),r+=t.length/n.channels/n.rate}},this.sync=function(){var e=a.currentTime
r=Math.min(r,e+.3)}},Guacamole.RawAudioPlayer.prototype=new Guacamole.AudioPlayer,Guacamole.RawAudioPlayer.isSupportedType=function(e){return!!Guacamole.AudioContextFactory.getAudioContext()&&null!==Guacamole.RawAudioFormat.parse(e)},Guacamole.RawAudioPlayer.getSupportedTypes=function(){return Guacamole.AudioContextFactory.getAudioContext()?["audio/L8","audio/L16"]:[]},Guacamole.AudioRecorder=function(){this.onclose=null,this.onerror=null},Guacamole.AudioRecorder.isSupportedType=function(e){return Guacamole.RawAudioRecorder.isSupportedType(e)},Guacamole.AudioRecorder.getSupportedTypes=function(){return Guacamole.RawAudioRecorder.getSupportedTypes()},Guacamole.AudioRecorder.getInstance=function(e,t){return Guacamole.RawAudioRecorder.isSupportedType(t)?new Guacamole.RawAudioRecorder(e,t):null},Guacamole.RawAudioRecorder=function(e,t){var n=this,a=Guacamole.RawAudioFormat.parse(t),r=Guacamole.AudioContextFactory.getAudioContext(),o=(navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia).bind(navigator),i=new Guacamole.ArrayBufferWriter(e),u=1===a.bytesPerSample?window.Int8Array:window.Int16Array,s=1===a.bytesPerSample?128:32768,l=0,c=0,d=null,f=null,h=null,p=function(e){if(0===e)return 1
var t=Math.PI*e
return Math.sin(t)/t},m=function(e,t){return-t<e&&e<t?p(e)*p(e/t):0},g=function(e,t){for(var n=(e.length-1)*t,a=Math.floor(n)-3+1,r=Math.floor(n)+3,o=0,i=a;i<=r;i++)o+=(e[i]||0)*m(n-i,3)
return o},v=function(e){var t=e.length
l+=t
var n=Math.round(l*a.rate/e.sampleRate),r=n-c
c+=r
for(var o=new u(r*a.channels),i=0;i<a.channels;i++)for(var d=e.getChannelData(i),f=i,h=0;h<r;h++)o[f]=g(d,h/(r-1))*s,f+=a.channels
return o},y=function(){o({audio:!0},function(e){h=r.createScriptProcessor(2048,a.channels,a.channels),h.connect(r.destination),h.onaudioprocess=function(e){i.sendData(v(e.inputBuffer).buffer)},f=r.createMediaStreamSource(e),f.connect(h),d=e},function(){i.sendEnd(),n.onerror&&n.onerror()})},w=function(){if(f&&f.disconnect(),h&&h.disconnect(),d)for(var e=d.getTracks(),t=0;t<e.length;t++)e[t].stop()
h=null,f=null,d=null,i.sendEnd()}
i.onack=function(e){e.code!==Guacamole.Status.Code.SUCCESS||d?(w(),i.onack=null,e.code===Guacamole.Status.Code.RESOURCE_CLOSED?n.onclose&&n.onclose():n.onerror&&n.onerror()):y()}},Guacamole.RawAudioRecorder.prototype=new Guacamole.AudioRecorder,Guacamole.RawAudioRecorder.isSupportedType=function(e){return!!Guacamole.AudioContextFactory.getAudioContext()&&null!==Guacamole.RawAudioFormat.parse(e)},Guacamole.RawAudioRecorder.getSupportedTypes=function(){return Guacamole.AudioContextFactory.getAudioContext()?["audio/L8","audio/L16"]:[]},Guacamole.BlobReader=function(e,t){var n,a=this,r=0
...
o.onload=function(){n.sendData(o.result),n.onack=function(a){t.onack&&t.onack(a),a.isError()||(t.onprogress&&t.onprogress(e,r-n.blobLength),i())}},o.onerror=function(){t.onerror&&t.onerror(e,r,o.error)},i()},this.sendEnd=function(){n.sendEnd()},this.onack=null,this.onerror=null,this.onprogress=null,this.oncomplete=null},Guacamole.Client=function(e){function t(e){e!=u&&(u=e,r.onstatechange&&r.onstatechange(u))}function n(){return u==i||u==o}function a(t){var n=g[t]
return null==n&&(n=g[t]=new Guacamole.Parser,n.oninstruction=e.oninstruction),n}var r=this,o=2,i=3,u=0,s=0,l=null,c={0:"butt",1:"round",2:"square"},d={0:"bevel",1:"miter",2:"round"},f=new Guacamole.Display,h={},p={},m={},g=[],v=[],y=[],w=new Guacamole.IntegerPool,S=[]
this.getDisplay=function(){return f},this.sendSize=function(t,a){n()&&e.sendMessage("size",t,a)},this.sendKeyEvent=function(t,a){n()&&e.sendMessage("key",a,t)},this.sendMouseState=function(t){if(n()){f.moveCursor(Math.floor(t.x),Math.floor(t.y))
var a=0
...
a.sendEnd()}},this.createOutputStream=function(){var e=w.next()
return S[e]=new Guacamole.OutputStream(r,e)},this.createAudioStream=function(t){var n=r.createOutputStream()
...
return e.sendMessage("put",t,o.index,n,a),o},this.requestObjectInputStream=function(t,a){n()&&e.sendMessage("get",t,a)},this.sendAck=function(t,a,r){n()&&e.sendMessage("ack",t,a,r)},this.sendBlob=function(t,a){n()&&e.sendMessage("blob",t,a)},this.endStream=function(t){n()&&(e.sendMessage("end",t),S[t]&&(w.free(t),delete S[t]))},this.onstatechange=null,this.onname=null,this.onerror=null,this.onaudio=null,this.onvideo=null,this.onclipboard=null,this.onfile=null,this.onfilesystem=null,this.onpipe=null,this.onsync=null
var b=function(e){var t=h[e]
return t||(t=0===e?f.getDefaultLayer():e>0?f.createLayer():f.createBuffer(),h[e]=t),t},I={"miter-limit":function(e,t){f.setMiterLimit(e,parseFloat(t))}},T={ack:function(e){var t=parseInt(e[0]),n=e[1],a=parseInt(e[2]),r=S[t]
r&&(r.onack&&r.onack(new Guacamole.Status(a,n)),a>=256&&S[t]===r&&(w.free(t),delete S[t]))},arc:function(e){var t=b(parseInt(e[0])),n=parseInt(e[1]),a=parseInt(e[2]),r=parseInt(e[3]),o=parseFloat(e[4]),i=parseFloat(e[5]),u=parseInt(e[6])
f.arc(t,n,a,r,o,i,0!=u)},audio:function(e){var t=parseInt(e[0]),n=e[1],a=v[t]=new Guacamole.InputStream(r,t),o=null
r.onaudio&&(o=r.onaudio(a,n)),o||(o=Guacamole.AudioPlayer.getInstance(a,n)),o?(p[t]=o,r.sendAck(t,"OK",0)):r.sendAck(t,"BAD TYPE",783)},blob:function(e){var t=parseInt(e[0]),n=e[1],a=v[t]
a&&a.onblob&&a.onblob(n)},body:function(e){var t=parseInt(e[0]),n=y[t],a=parseInt(e[1]),o=e[2],i=e[3]
if(n&&n.onbody){var u=v[a]=new Guacamole.InputStream(r,a)
n.onbody(u,o,i)}else r.sendAck(a,"Receipt of body unsupported",256)},cfill:function(e){var t=parseInt(e[0]),n=b(parseInt(e[1])),a=parseInt(e[2]),r=parseInt(e[3]),o=parseInt(e[4]),i=parseInt(e[5])
f.setChannelMask(n,t),f.fillColor(n,a,r,o,i)},clip:function(e){var t=b(parseInt(e[0]))
f.clip(t)},clipboard:function(e){var t=parseInt(e[0]),n=e[1]
if(r.onclipboard){var a=v[t]=new Guacamole.InputStream(r,t)
r.onclipboard(a,n)}else r.sendAck(t,"Clipboard unsupported",256)},close:function(e){var t=b(parseInt(e[0]))
f.close(t)},copy:function(e){var t=b(parseInt(e[0])),n=parseInt(e[1]),a=parseInt(e[2]),r=parseInt(e[3]),o=parseInt(e[4]),i=parseInt(e[5]),u=b(parseInt(e[6])),s=parseInt(e[7]),l=parseInt(e[8])
f.setChannelMask(u,i),f.copy(t,n,a,r,o,u,s,l)},cstroke:function(e){var t=parseInt(e[0]),n=b(parseInt(e[1])),a=c[parseInt(e[2])],r=d[parseInt(e[3])],o=parseInt(e[4]),i=parseInt(e[5]),u=parseInt(e[6]),s=parseInt(e[7]),l=parseInt(e[8])
f.setChannelMask(n,t),f.strokeColor(n,a,r,o,i,u,s,l)},cursor:function(e){var t=parseInt(e[0]),n=parseInt(e[1]),a=b(parseInt(e[2])),r=parseInt(e[3]),o=parseInt(e[4]),i=parseInt(e[5]),u=parseInt(e[6])
f.setCursor(t,n,a,r,o,i,u)},curve:function(e){var t=b(parseInt(e[0])),n=parseInt(e[1]),a=parseInt(e[2]),r=parseInt(e[3]),o=parseInt(e[4]),i=parseInt(e[5]),u=parseInt(e[6])
f.curveTo(t,n,a,r,o,i,u)},dispose:function(e){var t=parseInt(e[0])
if(t>0){b(t).dispose(),delete h[t]}else t<0&&delete h[t]},distort:function(e){var t=parseInt(e[0]),n=parseFloat(e[1]),a=parseFloat(e[2]),r=parseFloat(e[3]),o=parseFloat(e[4]),i=parseFloat(e[5]),u=parseFloat(e[6])
if(t>=0){b(t).distort(n,a,r,o,i,u)}},error:function(e){var t=e[0],n=parseInt(e[1])
r.onerror&&r.onerror(new Guacamole.Status(n,t)),r.disconnect()},end:function(e){var t=parseInt(e[0]),n=v[t]
n&&(n.onend&&n.onend(),delete v[t])},file:function(e){var t=parseInt(e[0]),n=e[1],a=e[2]
if(r.onfile){var o=v[t]=new Guacamole.InputStream(r,t)
r.onfile(o,n,a)}else r.sendAck(t,"File transfer unsupported",256)},filesystem:function(e){var t=parseInt(e[0]),n=e[1]
if(r.onfilesystem){var a=y[t]=new Guacamole.Object(r,t)
r.onfilesystem(a,n)}},identity:function(e){var t=b(parseInt(e[0]))
f.setTransform(t,1,0,0,1,0,0)},img:function(e){var t=parseInt(e[0]),n=parseInt(e[1]),a=b(parseInt(e[2])),o=e[3],i=parseInt(e[4]),u=parseInt(e[5]),s=v[t]=new Guacamole.InputStream(r,t),l=new Guacamole.DataURIReader(s,o)
l.onend=function(){f.setChannelMask(a,n),f.draw(a,i,u,l.getURI())}},jpeg:function(e){var t=parseInt(e[0]),n=b(parseInt(e[1])),a=parseInt(e[2]),r=parseInt(e[3]),o=e[4]
f.setChannelMask(n,t),f.draw(n,a,r,"data:image/jpeg;base64,"+o)},lfill:function(e){var t=parseInt(e[0]),n=b(parseInt(e[1])),a=b(parseInt(e[2]))
f.setChannelMask(n,t),f.fillLayer(n,a)},line:function(e){var t=b(parseInt(e[0])),n=parseInt(e[1]),a=parseInt(e[2])
f.lineTo(t,n,a)},lstroke:function(e){var t=parseInt(e[0]),n=b(parseInt(e[1])),a=b(parseInt(e[2]))
f.setChannelMask(n,t),f.strokeLayer(n,a)},move:function(e){var t=parseInt(e[0]),n=parseInt(e[1]),a=parseInt(e[2]),r=parseInt(e[3]),o=parseInt(e[4])
if(t>0&&n>=0){var i=b(t),u=b(n)
i.move(u,a,r,o)}},name:function(e){r.onname&&r.onname(e[0])},nest:function(e){a(parseInt(e[0])).receive(e[1])},pipe:function(e){var t=parseInt(e[0]),n=e[1],a=e[2]
if(r.onpipe){var o=v[t]=new Guacamole.InputStream(r,t)
r.onpipe(o,n,a)}else r.sendAck(t,"Named pipes unsupported",256)},png:function(e){var t=parseInt(e[0]),n=b(parseInt(e[1])),a=parseInt(e[2]),r=parseInt(e[3]),o=e[4]
f.setChannelMask(n,t),f.draw(n,a,r,"data:image/png;base64,"+o)},pop:function(e){var t=b(parseInt(e[0]))
f.pop(t)},push:function(e){var t=b(parseInt(e[0]))
f.push(t)},rect:function(e){var t=b(parseInt(e[0])),n=parseInt(e[1]),a=parseInt(e[2]),r=parseInt(e[3]),o=parseInt(e[4])
f.rect(t,n,a,r,o)},reset:function(e){var t=b(parseInt(e[0]))
f.reset(t)},set:function(e){var t=b(parseInt(e[0])),n=e[1],a=e[2],r=I[n]
r&&r(t,a)},shade:function(e){var t=parseInt(e[0]),n=parseInt(e[1])
if(t>=0){b(t).shade(n)}},size:function(e){var t=parseInt(e[0]),n=b(t),a=parseInt(e[1]),r=parseInt(e[2])
f.resize(n,a,r)},start:function(e){var t=b(parseInt(e[0])),n=parseInt(e[1]),a=parseInt(e[2])
f.moveTo(t,n,a)},sync:function(n){var a=parseInt(n[0])
f.flush(function(){for(var t in p){var n=p[t]
n&&n.sync()}a!==s&&(e.sendMessage("sync",a),s=a)}),u===o&&t(i),r.onsync&&r.onsync(a)},transfer:function(e){var t=b(parseInt(e[0])),n=parseInt(e[1]),a=parseInt(e[2]),r=parseInt(e[3]),o=parseInt(e[4]),i=parseInt(e[5]),u=b(parseInt(e[6])),s=parseInt(e[7]),l=parseInt(e[8])
3===i?f.put(t,n,a,r,o,u,s,l):5!==i&&f.transfer(t,n,a,r,o,u,s,l,Guacamole.Client.DefaultTransferFunction[i])},transform:function(e){var t=b(parseInt(e[0])),n=parseFloat(e[1]),a=parseFloat(e[2]),r=parseFloat(e[3]),o=parseFloat(e[4]),i=parseFloat(e[5]),u=parseFloat(e[6])
f.transform(t,n,a,r,o,i,u)},undefine:function(e){var t=parseInt(e[0]),n=y[t]
n&&n.onundefine&&n.onundefine()},video:function(e){var t=parseInt(e[0]),n=b(parseInt(e[1])),a=e[2],o=v[t]=new Guacamole.InputStream(r,t),i=null
r.onvideo&&(i=r.onvideo(o,n,a)),i||(i=Guacamole.VideoPlayer.getInstance(o,n,a)),i?(m[t]=i,r.sendAck(t,"OK",0)):r.sendAck(t,"BAD TYPE",783)}}
e.oninstruction=function(e,t){var n=T[e]
n&&n(t)},this.disconnect=function(){5!=u&&4!=u&&(t(4),l&&window.clearInterval(l),e.sendMessage("disconnect"),e.disconnect(),t(5))},this.connect=function(n){t(1)
try{e.connect(n)}catch(e){throw t(0),e}l=window.setInterval(function(){e.sendMessage("sync",s)},5e3),t(o)}},Guacamole.Client.DefaultTransferFunction={0:function(e,t){t.red=t.green=t.blue=0},15:function(e,t){t.red=t.green=t.blue=255},3:function(e,t){t.red=e.red,t.green=e.green,t.blue=e.blue,t.alpha=e.alpha},5:function(e,t){},12:function(e,t){t.red=255&~e.red,t.green=255&~e.green,t.blue=255&~e.blue,t.alpha=e.alpha},10:function(e,t){t.red=255&~t.red,t.green=255&~t.green,t.blue=255&~t.blue},1:function(e,t){t.red=e.red&t.red,t.green=e.green&t.green,t.blue=e.blue&t.blue},14:function(e,t){t.red=255&~(e.red&t.red),t.green=255&~(e.green&t.green),t.blue=255&~(e.blue&t.blue)},7:function(e,t){t.red=e.red|t.red,t.green=e.green|t.green,t.blue=e.blue|t.blue},8:function(e,t){t.red=255&~(e.red|t.red),t.green=255&~(e.green|t.green),t.blue=255&~(e.blue|t.blue)},6:function(e,t){t.red=e.red^t.red,t.green=e.green^t.green,t.blue=e.blue^t.blue},9:function(e,t){t.red=255&~(e.red^t.red),t.green=255&~(e.green^t.green),t.blue=255&~(e.blue^t.blue)},4:function(e,t){t.red=~e.red&t.red&255,t.green=~e.green&t.green&255,t.blue=~e.blue&t.blue&255},13:function(e,t){t.red=255&(~e.red|t.red),t.green=255&(~e.green|t.green),t.blue=255&(~e.blue|t.blue)},2:function(e,t){t.red=e.red&~t.red&255,t.green=e.green&~t.green&255,t.blue=e.blue&~t.blue&255},11:function(e,t){t.red=255&(e.red|~t.red),t.green=255&(e.green|~t.green),t.blue=255&(e.blue|~t.blue)}},Guacamole.DataURIReader=function(e,t){var n=this,a="data:"+t+";base64,"
...
!1===e?n&&n.removeChild(t):n!==s&&s.appendChild(t)},this.moveCursor=function(e,t){c.translate(e-r.cursorHotspotX,t-r.cursorHotspotY),r.cursorX=e,r.cursorY=t},this.resize=function(e,t,n){a(function(){e.resize(t,n),e===l&&(o=t,i=n,s.style.width=o+"px",s.style.height=i+"px",d.style.width=o*u+"px",d.style.height=i*u+"px",r.onresize&&r.onresize(t,n))})},this.drawImage=function(e,t,n,r){a(function(){e.drawImage(t,n,r)})},this.drawBlob=function(e,t,n,r){var o=URL.createObjectURL(r),i=a(function(){e.drawImage(t,n,u),URL.revokeObjectURL(o)},!0),u=new Image
...
r=e}return!0===n?r=r.toUpperCase():!1===n&&(r=r.toLowerCase()),a(r.charCodeAt(0))}function n(e){return e<=31||e>=127&&e<=159}function a(e){return n(e)?65280|e:e>=0&&e<=255?e:e>=256&&e<=1114111?16777216|e:null}function r(e,t){return w(f[e],t)}function o(){var e=G()
if(!e)return!1
var t
do{t=e,e=G()}while(null!==e)
...
var s=!(i.modifiers.ctrl||navigator&&navigator.platform&&navigator.platform.match(/^mac/i));(!i.modifiers.alt&&i.modifiers.ctrl||s&&i.modifiers.alt||i.modifiers.meta||i.modifiers.hyper)&&(this.reliable=!0),g[e]=this.keysym}
s.prototype=new u
var l=function(e){u.apply(this),this.charCode=e,this.keysym=a(e),this.reliable=!0}
l.prototype=new u
var c=function(e,n,a,o){u.apply(this),this.keyCode=e,this.keyIdentifier=n,this.key=a,this.location=o,this.keysym=g[e]||r(e,o)||t(a,o),this.reliable=!0}
c.prototype=new u
...
var m={},g={},v=null,y=null,w=function(e,t){return e?e[t]||e[0]:null},S=function(e){return e>=0&&e<=255||16777216==(4294901760&e)},b=function(e,t){if(!t)return!1
var n=t.indexOf("U+")
return-1===n||(e!==parseInt(t.substring(n+2),16)||e>=65&&e<=90||e>=48&&e<=57)}
this.press=function(e){if(null!==e){if(!i.pressed[e]&&(i.pressed[e]=!0,i.onkeydown)){var t=i.onkeydown(e)
return m[e]=t,window.clearTimeout(v),window.clearInterval(y),p[e]||(v=window.setTimeout(function(){y=window.setInterval(function(){i.onkeyup(e),i.onkeydown(e)},50)},500)),t}return m[e]||!1}},this.release=function(e){i.pressed[e]&&(delete i.pressed[e],window.clearTimeout(v),window.clearInterval(y),null!==e&&i.onkeyup&&i.onkeyup(e))},this.reset=function(){for(var e in i.pressed)i.release(parseInt(e))
d=[]}
var I=function(e){var t=Guacamole.Keyboard.ModifierState.fromKeyboardEvent(e)
i.modifiers.alt&&!1===t.alt&&(i.release(65513),i.release(65514),i.release(65027)),i.modifiers.shift&&!1===t.shift&&(i.release(65505),i.release(65506)),i.modifiers.ctrl&&!1===t.ctrl&&(i.release(65507),i.release(65508)),i.modifiers.meta&&!1===t.meta&&(i.release(65511),i.release(65512)),i.modifiers.hyper&&!1===t.hyper&&(i.release(65515),i.release(65516)),i.modifiers=t},T=function(e){i.modifiers.ctrl&&i.modifiers.alt&&(e>=65&&e<=90||e>=97&&e<=122||(e<=255||16777216==(4278190080&e))&&(i.release(65507),i.release(65508),i.release(65513),i.release(65514)))},G=function(){var e=d[0]
if(!e)return null
...
var a=!i.press(t)
g[e.keyCode]=t,i.modifiers.meta&&65511!==t&&65512!==t&&i.release(t)
...
n.getContext("2d").drawImage(o,0,0,r.width,r.height,0,0,r.width,r.height)}var a=i.globalCompositeOperation
o.width=e,o.height=t,n&&i.drawImage(n,0,0,r.width,r.height,0,0,r.width,r.height),i.globalCompositeOperation=a,r.width=e,r.height=t,s=0,i.save()}function a(e,t,n,a){var o,i=n+e,u=a+t
...
for(var f=e.getCanvas().getContext("2d").getImageData(t,n,o,u),h=i.getImageData(s,l,o,u),p=0;p<o*u*4;p+=4){var m=new Guacamole.Layer.Pixel(f.data[p],f.data[p+1],f.data[p+2],f.data[p+3]),g=new Guacamole.Layer.Pixel(h.data[p],h.data[p+1],h.data[p+2],h.data[p+3])
c(m,g),h.data[p]=g.red,h.data[p+1]=g.green,h.data[p+2]=g.blue,h.data[p+3]=g.alpha}i.putImageData(h,s,l)}},this.put=function(e,t,n,o,u,s,l){var c=e.getCanvas()
...
if(n?1===e.deltaMode?n=e.deltaY*r.PIXELS_PER_LINE:2===e.deltaMode&&(n=e.deltaY*r.PIXELS_PER_PAGE):n=e.detail*r.PIXELS_PER_LINE,(i+=n)<=-r.scrollThreshold){do{r.onmousedown&&(r.currentState.up=!0,r.onmousedown(r.currentState)),r.onmouseup&&(r.currentState.up=!1,r.onmouseup(r.currentState)),i+=r.scrollThreshold}while(i<=-r.scrollThreshold)
i=0}if(i>=r.scrollThreshold){do{r.onmousedown&&(r.currentState.down=!0,r.onmousedown(r.currentState)),r.onmouseup&&(r.currentState.down=!1,r.onmouseup(r.currentState)),i-=r.scrollThreshold}while(i>=r.scrollThreshold)
i=0}t(e)}var r=this
...
var o=0,i=0
e.addEventListener("contextmenu",function(e){t(e)},!1),e.addEventListener("mousemove",function(n){if(t(n),o)return void o--
r.currentState.fromClientPosition(e,n.clientX,n.clientY),r.onmousemove&&r.onmousemove(r.currentState)},!1),e.addEventListener("mousedown",function(e){if(t(e),!o){switch(e.button){case 0:r.currentState.left=!0
break
...
try{e.style.cursor="url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEX///+nxBvIAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==) 0 0, auto"}catch(e){return!1}return/\burl\([^()]*\)\s+0\s+0\b/.test(e.style.cursor||"")}()
...
r(a.clientX,a.clientY),t("left"),f=window.setTimeout(function(){n("left"),u()},s.clickTimingThreshold)}}},!1),e.addEventListener("touchstart",function(e){if(1!==e.touches.length)return void u()
e.preventDefault(),i(e),window.clearTimeout(f),h=window.setTimeout(function(){var t=e.touches[0]
...
return n}return"number"==typeof t?[new Guacamole.OnScreenKeyboard.Key({name:e,keysym:t})]:"string"==typeof t?[new Guacamole.OnScreenKeyboard.Key({name:e,title:t})]:[new Guacamole.OnScreenKeyboard.Key(t,e)]}
this.keys=function(t){var n={}
for(var a in e.keys)n[a]=p(a,t[a])
return n}(e.keys)
var m=function(e){return e.replace(/([a-z])([A-Z])/g,"$1-$2").replace(/[^A-Za-z0-9]+/g,"-").toLowerCase()}
!function e(n,a,i){var l,c=document.createElement("div")
if(i&&o(c,"guac-keyboard-"+m(i)),a instanceof Array)for(o(c,"guac-keyboard-group"),l=0;l<a.length;l++)e(c,a[l])
else if(a instanceof Object){o(c,"guac-keyboard-group")
var h=Object.keys(a).sort()
for(l=0;l<h.length;l++){var i=h[l]
e(c,a[i],i)}}else if("number"==typeof a)o(c,"guac-keyboard-gap"),r.push(new s(c,a,a))
else if("string"==typeof a){var p=a
...
var v=t.keys[a]
if(v)for(l=0;l<v.length;l++){var y=v[l],w=document.createElement("div")
w.className="guac-keyboard-cap",w.textContent=y.title
for(var S=0;S<y.requires.length;S++){var b=y.requires[S]
o(w,"guac-keyboard-requires-"+m(b)),o(g,"guac-keyboard-uses-"+m(b))}g.appendChild(w)}c.appendChild(g),r.push(new s(c,t.layout.keyWidths[a]||1,1,!0))
var I=function(e){e.preventDefault(),u=t.touchMouseThreshold,d(a,g)},T=function(e){e.preventDefault(),u=t.touchMouseThreshold,f(a,g)},G=function(e){e.preventDefault(),0===u&&d(a,g)},C=function(e){e.preventDefault(),0===u&&f(a,g)}
g.addEventListener("touchstart",I,!0),g.addEventListener("touchend",T,!0),g.addEventListener("mousedown",G,!0),g.addEventListener("mouseup",C,!0),g.addEventListener("mouseout",C,!0)}n.appendChild(c)}(h,e.layout)},Guacamole.OnScreenKeyboard.Layout=function(e){this.language=e.language,this.type=e.type,this.keys=e.keys,this.layout=e.layout,this.width=e.width,this.keyWidths=e.keyWidths||{}},Guacamole.OnScreenKeyboard.Key=function(e,t){this.name=t||e.name,this.title=e.title||this.name,this.keysym=e.keysym||function(e){if(!e||1!==e.length)return null
var t=e.charCodeAt(0)
return t>=0&&t<=255?t:t>=256&&t<=1114111?16777216|t:null}(this.title),this.modifier=e.modifier,this.requires=e.requires||[]},Guacamole.OutputStream=function(e,t){var n=this
...
0===r?127==(127|i)?t+=String.fromCharCode(i):223==(31|i)?(o=31&i,r=1):239==(15|i)?(o=15&i,r=2):247==(7|i)?(o=7&i,r=3):t+="�":191==(63|i)?(o=o<<6|63&i,0===--r&&(t+=String.fromCharCode(o))):(r=0,t+="�")}return t}var n=this,a=new Guacamole.ArrayBufferReader(e),r=0,o=0
...
try{l=e.status}catch(e){l=200}if(r||200!==l||(r=u()),3===e.readyState||4===e.readyState){if(n(),p===f&&(3!==e.readyState||a?4!==e.readyState||a||clearInterval(a):a=setInterval(t,30)),0===e.status)return void s.disconnect()
if(200!==e.status)return void o(e)
var h
try{h=e.responseText}catch(e){return}for(;c<h.length;){if(c>=d){var g=h.substring(d,c),v=h.substring(c,c+1)
if(m.push(g),";"===v){var y=m.shift()
s.oninstruction&&s.oninstruction(y,m),m.length=0}d=c+1}var w=h.indexOf(".",d)
if(-1===w){d=h.length
break}var S=parseInt(h.substring(c+1,w))
if(0===S){a||clearInterval(a),e.onreadystatechange=null,e.abort(),r&&i(r)
break}d=w+1,c=d+S}}}}var a=null,r=null,l=0,c=-1,d=0,m=new Array
e.onreadystatechange=p===f?function(){3===e.readyState&&++l>=2&&(p=h,e.onreadystatechange=t),t()}:t,t()}function u(){var e=new XMLHttpRequest
return e.open("GET",c+s.uuid+":"+w++),e.withCredentials=v,e.send(null),e}var s=this,l=e+"?connect",c=e+"?read:",d=e+"?write:",f=1,h=0,p=f,m=!1,g="",v=!!t,y=null
